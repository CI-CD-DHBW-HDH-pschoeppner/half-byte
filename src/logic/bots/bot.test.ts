...
describe("randomMove()", () => {
    ...
    it("returns the only empty field index", () => {
        const board = [
            Field.PLAYER1, Field.PLAYER2, Field.PLAYER1,
            Field.PLAYER1, Field.EMPTY, Field.PLAYER2,
            Field.PLAYER2, Field.PLAYER1, Field.PLAYER1,
        ];
...
describe("winningMove()", () => {
    ...
    it("returns the index of the field to play in the next move in order to win", () => {
        let board = [
            Field.PLAYER1, Field.PLAYER1, Field.PLAYER1,
            Field.PLAYER2, Field.EMPTY, Field.PLAYER2,
            Field.PLAYER1, Field.PLAYER2, Field.PLAYER1,
        ];
        ...
        board = [
            Field.PLAYER2, Field.PLAYER1, Field.PLAYER1,
            Field.PLAYER2, Field.EMPTY, Field.PLAYER2,
            Field.EMPTY, Field.PLAYER2, Field.PLAYER1,
        ];
...
describe("mediumMove()", () => {
    it("returns the winning field index if the player can win", () => {
        const board = [
            Field.PLAYER1, Field.PLAYER1, Field.EMPTY,
            Field.EMPTY, Field.PLAYER2, Field.PLAYER2,
            Field.PLAYER2, Field.EMPTY, Field.EMPTY,
        ];
    ...
    it("chooses the middle (4) field if it cannot block or win in the next move", () => {
        const board = [
            Field.PLAYER1, Field.EMPTY, Field.EMPTY,
            Field.EMPTY, Field.EMPTY, Field.PLAYER2,
            Field.PLAYER2, Field.PLAYER1, Field.EMPTY,
        ];
        const player = Field.PLAYER1;
